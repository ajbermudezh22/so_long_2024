...
SRC := main.c accessibility.c game_logic.c graphics.c keyboard_controls.c map_utils.c parse_map.c validate_map.c
NAME := so_long
HEADER := so_long.h
...
$(NAME): $(SRC) $(LIBFT_ARCHIVE) $(MLX_ARCHIVE) $(HEADER)
	$(CC) $(CFLAGS) -o $@ $(SRC) -I$(LIBFT_PATH) -I$(MLX_PATH) -L$(LIBFT_PATH) -lft $(MLX_FLAGS)
